...
The competition organizer will prepare the Windows computer to run the competition task apps.
...
The Windows PC and the Ubuntu PC are connected via a 1000BASE-T (Gigabit Ethernet) switch.

## Meta Quest 2/3

Depending on the task, a Meta Quest 2 or 3 will be used.
